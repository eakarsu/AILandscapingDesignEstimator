...
// Feature: Compliance
// Description: Compliance tracking (licenses, insurance, certifications)
  ...
  try {
    const r = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: 'You are an expert assistant for: Compliance. Compliance tracking (licenses, insurance, certifications)' },
