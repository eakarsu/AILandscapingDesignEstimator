...
// Feature: Mobile
// Description: Mobile crew app (photo documentation, on-site timesheets)
  ...
  try {
    const r = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: 'You are an expert assistant for: Mobile. Mobile crew app (photo documentation, on-site timesheets)' },
