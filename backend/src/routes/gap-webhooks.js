...
// Feature: Webhooks
// Description: Webhooks for accounting/CRM integration
  ...
  try {
    const r = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: 'You are an expert assistant for: Webhooks. Webhooks for accounting/CRM integration' },
