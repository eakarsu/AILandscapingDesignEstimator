...
// Agentic
// Agentic crew scheduling optimizing assignments across projects (travel time, skill utilization)
...
export default function GapAgentic() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Agentic crew scheduling optimizing assignments across projects (travel time, skill utilization)</p>
