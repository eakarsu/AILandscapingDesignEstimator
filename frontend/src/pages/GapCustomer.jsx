...
// Customer
// Customer journey upsell agent (maintenance plans, seasonal services)

export default function GapCustomer() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-customer', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Customer</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Customer journey upsell agent (maintenance plans, seasonal services)</p>
