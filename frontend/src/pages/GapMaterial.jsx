...
// Material
// Material price aggregator monitoring supplier feeds with bulk-buy alerts

export default function GapMaterial() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-material', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Material</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Material price aggregator monitoring supplier feeds with bulk-buy alerts</p>
