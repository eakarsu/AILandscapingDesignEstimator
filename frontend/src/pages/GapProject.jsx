...
// Project
// Project timeline / critical path (Gantt, dependency tracking)

export default function GapProject() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-project', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Project</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Project timeline / critical path (Gantt, dependency tracking)</p>
