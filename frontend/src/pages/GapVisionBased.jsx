...
// Vision Based
// Vision-based landscape audit: upload site photos, AI generates design suggestions with cost estimates
...
export default function GapVisionBased() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Vision-based landscape audit: upload site photos, AI generates design suggestions with cost estimates</p>
