...
// White Label
// White-label multi-tenant SaaS for franchise landscape operators
...
export default function GapWhiteLabel() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>White-label multi-tenant SaaS for franchise landscape operators</p>
